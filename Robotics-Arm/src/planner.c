...
*/
switchingTimes* determineSwitchingTimes (float_t targetPos, float_t initialPos, float_t initialVel, PosCtrlHandle *currentMotionPlan, VelocityFilter *motorTracker){
